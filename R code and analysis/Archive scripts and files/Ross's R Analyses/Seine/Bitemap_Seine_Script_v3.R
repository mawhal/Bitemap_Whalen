...
#subset data
seine.div <- select(bitemap.seine, Site.Name, Lat, Seagrass.Unveg, genus.species, Abundance)
...
simpson <- diversity(seine.mat[,4:116], "simpson")
...
seine.mat.runme <- seine.mat[,c(4:116)]
